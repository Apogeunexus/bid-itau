...
/**
 * `comSeparador` mora no contrato, em `tipos-acesso.ts`, porque as duas pontas do modelo de
 * acesso formatam número — o produtor no quadro de conversão, a moderação na fila. Aqui ela
 * é REEXPORTADA e não recriada: as telas da jornada já a importam deste módulo, e uma
 * segunda implementação seria a mesma duplicação que este arquivo existe para desfazer.
 */
export { comSeparador } from "@/dados/tipos-acesso";
