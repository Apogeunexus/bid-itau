 ...
 * ingestão federada entrou: os 19 eventos COMPLETOS do Theatro Municipal, do MASP e da
 * Casa das Rosas levaram «com sessão» de 129 para 148. O número caiu de 150 quando o
 * crivo passou a exigir ficha completa: dois entravam sem descrição. A INTERSEÇÃO NÃO MUDOU e é isso que importa — parceiro
...
export const EVENTOS_COM_SESSAO_ESPERADOS = 148;
